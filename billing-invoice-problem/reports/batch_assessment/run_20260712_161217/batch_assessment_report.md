...
_Generated: 2026-07-12T16:12:17.301796+00:00_
_Run dir: `D:\Personal\DS\ds-assignment\billing-invoice-problem\ds-assignment\billing-invoice-problem\reports\batch_assessment\run_20260712_161217`_
...
Risk ↑:
- total invoice lines (18) [shap +1.782]
- days since last invoice (526) [shap +0.817]
- revenue trend (recent vs prior year) (0.00) [shap +0.646]
- typical days between invoices (1) [shap +0.474]

Risk ↓:
- billing-interval confidence (0.63) [shap -0.269]
- most recent invoice amount (49.00) [shap -0.250]
- largest invoice amount (49.00) [shap -0.079]
- dominant-cadence share (1.00) [shap -0.034]
...
- Recommendation: **No-Go** (high_churn_risk)
- P(churn): 0.9948 · Expected $: 2.37 · Interval: `monthly` (conf=0.6332)
- Tier: High risk · Confidence: High (|p-0.5| margin 0.99)

**Main reason:** total invoice lines (increasing risk)

Risk ↑:
- total invoice lines (14) [shap +1.587]
- revenue trend (recent vs prior year) (0.00) [shap +0.923]
- days since last invoice (501) [shap +0.865]
- number of billing events (14) [shap +0.521]

Risk ↓:
- billing-interval confidence (0.63) [shap -0.302]
- most recent invoice amount (49.00) [shap -0.230]
- revenue in the prior 12 months (588.00) [shap -0.154]
- largest invoice amount (49.00) [shap -0.091]
...
Risk ↑:
- total invoice lines (13) [shap +1.755]
- days since last invoice (679) [shap +0.671]
- average invoice amount (49.00) [shap +0.497]
- number of billing events (13) [shap +0.480]

Risk ↓:
- billing-interval confidence (0.56) [shap -0.459]
- most recent invoice amount (49.00) [shap -0.173]
- lifetime revenue (637.00) [shap -0.104]
- largest invoice amount (49.00) [shap -0.095]
